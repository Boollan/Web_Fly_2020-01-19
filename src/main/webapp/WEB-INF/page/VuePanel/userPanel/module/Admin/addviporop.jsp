...
<%@ include file="internal/title.jsp" %>
    <div class="panel-body">
        ...
        <div class="uk-text-center" style="font-size: 16px"> 添加玩家VIP|OP</div>
        ...
        <div class="uk-align-center uk-text-center">
            ...
            <div class="uk-margin">
                <label class="uk-form-label" for="datetime">时间:</label>
                <select class="uk-select uk-form-width-medium uk-form-small" id="datetime">
            ...
            <div class="uk-margin">
                <label class="uk-form-label" for="steamid">密码:</label>
                <input class="uk-input uk-form-width-medium uk-form-small" placeholder="请输入管理员密码" id="adminPassword" type="password" >
            </div>
            <div class="uk-margin">
                <button class="uk-button uk-button-primary  uk-button-default demo" id="sub" type="button">添加</button>
            </div>
        </div>
    ...
    window.onload = function () {
        ...
        var demo_4 = _dx.Captcha(document.getElementById('demo-popup'), {
            ...
            success: function (token) {
                ...
                xmlhttp.send("steamid="+steamid.value+"&dataTime="+datetime.value+"&type="+type.value+"&adminPassword="+adminPassword.value+"&token="+token);//POST请求体
