...
<section class="ui-container">
    <section id="panel">
        <h1 style="text-align: center;">兔子窝找回密码</h1>
        ...
        <div class="ui-btn-wrap">
            <button class="ui-btn-lg ui-btn-primary" id="sub" style="background-color: #208DF1;">重置密码</button>
        </div>

        <div class="checkbox ui-border-b" style="margin-right: 3%;text-align: right;">
            <label>
                <div>
                    <a style="color: #0f0f0f;" href="/UiMobile/Login">
                        <nobr>登录页面</nobr>
                    </a>
                </div>
            </label>
...
<script type="text/javascript">
    window.onload = function () {
        ...
        //注册
        const resetPassword = _dx.Captcha(document.getElementById('demo-popup'), {
            ...
            success: function (token_code) {
                ...
                xmlhttp.open("POST", "/User/ResetPassword", false);
                xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xmlhttp.send("username="+username.value+"&email="+email.value+"&code="+emailcode.value+"&newPassword="+newPassword.value+"&token="+token_code);//POST请求体
...
<div class="ui-dialog" id="message_tow">
    <div class="ui-dialog-cnt">
        <div class="ui-dialog-bd">
            <h1>重置密码失败!</h1>
            <p style="font-size: 10px">账号或邮箱不存在或验证码不正确···</p>
        </div>
